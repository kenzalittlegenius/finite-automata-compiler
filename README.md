...
Depuis l’expression rationnelle e donnée en entrée, votre Gal devra construire séquentiellement : — l’arbre de syntaxe abstraite T de e (construit de la gauche vers la droite comme cela a été vu en cours et en TD);
